...
export function buildUI(el) {
    ...
    header.innerHTML = `
        ...
        <div class="pn-generate">
            ...
            <button class="pn-upload-btn" title="Upload JSON-LD track" aria-label="Upload"><svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M8 13V4"/><path d="M4.5 7.5L8 4l3.5 3.5"/><path d="M3 13.5h10"/></svg></button>
        ...
        <div class="pn-audio-mode">
            ...
            <button class="pn-view-card-btn" title="View share card" aria-label="View share card" style="display:none">
                <svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="3" width="12" height="10" rx="1.5"/><circle cx="6" cy="7.5" r="1.4" fill="currentColor" stroke="none"/><path d="M3 12 L6.5 9 L9 11 L13 7"/></svg>
            </button>
