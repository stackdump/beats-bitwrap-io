...
export function buildUI(el) {
    ...
    header.innerHTML = `
        ...
        <div class="pn-audio-mode">
            ...
            <a class="pn-gh-link" href="/docs/control-category.html" target="_blank" rel="noopener" title="Control category map — how beat fans out through generators, instruments, macros, controls">
