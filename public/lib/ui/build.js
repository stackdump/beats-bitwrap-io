    ...
    header.innerHTML = `
        ...
        <div class="pn-audio-mode">
            ...
            <button class="pn-view-card-btn" title="View share card" aria-label="View share card" style="display:none">
                <svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M1.5 8 C 4 3.5, 12 3.5, 14.5 8 C 12 12.5, 4 12.5, 1.5 8 Z"/><circle cx="8" cy="8" r="2.2" fill="currentColor" stroke="none"/></svg>
            </button>
